...
static int
fpathconf_fd_converter(PyObject *o, void *p)
{
    if (!_fd_converter(o, (int *)p)) {
        return 0;
    }
    if (*(int *)p < 0) {
...
class fpathconf_fd_converter(CConverter):
    type = 'int'
    converter = 'fpathconf_fd_converter'
...
[python start generated code]*/
/*[python end generated code: output=da39a3ee5e6b4b0d input=835f2a6190c6c91f]*/
...
/*[clinic end generated code: output=d5b7042425fc3e21 input=49c6dba0ce06fcb9]*/
{
    long limit;
...
/*[clinic end generated code: output=5bedee35b293a089 input=6f6072f57b10c787]*/
{
    ...
    /* Validate file descriptor if provided via int */
    if (path->fd != -1 && path->fd < 0) {
        PyErr_SetString(PyExc_ValueError, "file descriptor cannot be negative");
        return -1;
    }
    /* Detect integer -1 which path_t treats as sentinel but should be rejected as fd */
    if (path->fd == -1 && path->narrow == NULL && path->wide == NULL) {
        PyErr_SetString(PyExc_ValueError, "file descriptor cannot be negative");
        return -1;
    }
